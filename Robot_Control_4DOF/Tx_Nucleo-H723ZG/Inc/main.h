...
#define IRQ_Tx_Pin GPIO_PIN_0
#define IRQ_Tx_GPIO_Port GPIOG
#define IRQ_Tx_EXTI_IRQn EXTI0_IRQn
...
#define Movement_Pin GPIO_PIN_1
#define Movement_GPIO_Port GPIOD
